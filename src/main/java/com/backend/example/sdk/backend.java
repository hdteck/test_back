package com.backend.example.sdk;
...
public class backend {
    ...
    public static String backend_DEV_URL = "https://ccapi-stg.backend.com";
    public static String backend_PROD_URL = "https://ccapi.backend.com";
    ...
    public static String backendDebitJson(Customer customer, String session_id, String token, double amount, String dev_reference, String description) {
    ...
    public static String backendDeleteJson(String uid, String token) {
        return "{" +
                    "\"card\": {" +
                        "\"token\": \"" +token + "\"" +
                    "}," +
    ...
    public static String backendVerifyJson(String uid, String transaction_id, String type, String value) {
        return "{" +
                    "\"user\": {" +
                        "\"id\": \"" + uid + "\"" +
                    "}," +
    ...
    public static Map<String, String> doPostRequest(String url, String json){
        ...
        Request request = new Request.Builder()
                .header("Auth-Token", backend.getAuthToken(System.getenv("backend_APP_SERVER_CODE"), System.getenv("backend_APP_SERVER_KEY")))
                .url(url)
                .post(body)
                .build();
